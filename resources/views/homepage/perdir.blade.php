  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <div class="navbar center">
        ...
        <li class="breadcrumb-item active">Perdir</li>
    </div>
    </ul>
          ...
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="../../pages/itgoverment/perdir.html" class="nav-link">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default color-palette-box">
          <div class="card-header">
            ...
            <a href='perdir.create_perdir' class="btn btn-success">Tambah Data <i class="fas fa-plus-square"></i></a>
            </div>
          </div>
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    @foreach ($perdirs as $index => $val)
                    <tr>
                        <td>{{++index}}</td>
                        <td>{{$val->uraian_perdir}}</td>
                        <td>{{$val->no_perdir}}</td>
                        <td>{{$val->tgl}}</td>
                        <td>{{$val->pdf}}</td>
                        <td>{{}}</td>
